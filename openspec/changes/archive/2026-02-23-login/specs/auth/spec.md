...
This specification defines the authentication system for the chat application. It establishes the requirements and behaviors for user login, session management, protected routes, and logout functionality. The authentication system replaces the insecure user selection flow where users could impersonate others by simply clicking a user card.
